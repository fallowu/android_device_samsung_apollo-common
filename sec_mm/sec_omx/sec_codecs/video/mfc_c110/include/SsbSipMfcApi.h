...
#define MFC_SET_CONFIG_POST_ROTATE					(0x0ABDE001)
...
typedef enum {
    ...
    /* S5P6440 feature */
    MFC_DEC_SETCONF_POST_ROTATE,
    MFC_DEC_GETCONF_PHYADDR_FRAM_BUF,
    MFC_DEC_GETCONF_FRAM_NEED_COUNT
} SSBSIP_MFC_DEC_CONF;
...
typedef struct {
    int *YPhyAddr;                     /* [IN/OUT] physical address of Y */
    int *CPhyAddr;                     /* [IN/OUT] physical address of CbCr */
    int *YVirAddr;                     /* [IN/OUT] virtual address of Y */
    int *CVirAddr;                     /* [IN/OUT] virtual address of CbCr */
...
SSBSIP_MFC_ERROR_CODE SsbSipMfcDecInit(void *openHandle, SSBSIP_MFC_CODEC_TYPE codec_type, int lengthBufFill);
