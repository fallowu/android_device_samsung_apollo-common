...
public:
    ...
    virtual status_t setVoiceVolume_l(float volume);
...
private:
    ...
    int        (*registerUnsolicitedHandler) (HRilClient , uint32_t , RilOnUnsolicited );
    int        (*registerRequestCompleteHandler)     (HRilClient , uint32_t , RilOnComplete );
